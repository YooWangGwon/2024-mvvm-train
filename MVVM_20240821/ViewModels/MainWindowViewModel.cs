...
namespace MVVM_20240821.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public ICommand ProceedCommand => proceedCommand ?? (proceedCommand = new
            RelayCommand<object>(o => Proceed(), o => !string.IsNullOrEmpty(inEmail) &&
